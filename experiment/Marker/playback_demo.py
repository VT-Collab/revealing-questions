...
# TO_START_TIME = 3     #how long the robot has to get to the first waypoint
AT_START_TIME = 0.01     #how long the robot waits at the first waypoint
AT_END_TIME = 0.01       #how long the robot waits at the last waypoint
...
class TrajectoryClient(object):
    ...
    def load_trajectory(self, trajectory, TO_START_TIME):
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        mover.load_trajectory(data, TO_START_TIME)
        mover.send()
        mover.gripper_open()
        mover.gripper_close()
